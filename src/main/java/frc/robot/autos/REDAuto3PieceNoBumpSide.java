...
public class REDAuto3PieceNoBumpSide extends SequentialCommandGroup {
  /** Creates a new Auto2PieceNoBumpSide. */
  public REDAuto3PieceNoBumpSide(WristSubsystem wristSubsystem, ElevatorSubsystem elevatorSubsystem,
    ...
    addCommands(
        ...
        new WaitCommand(.75),
        new ParallelRaceGroup(
            new CreatePathCommand(driveSubsystem, new Pose2d(1.89233, 5.2, Rotation2d.fromDegrees(180)),
                List.of(new Translation2d(6.5, 5)), new Pose2d(7.05866, 6.6, Rotation2d.fromDegrees(1)), true, false),
            new IntakeCommand(intakeSubsystem, true)),
        new SetArmPosition(wristSubsystem, elevatorSubsystem, true),
        new CreatePathCommand(driveSubsystem, new Pose2d(7.05866, 6.6, Rotation2d.fromDegrees(1)), List.of(new Translation2d(6.5, 5)), new Pose2d(1.89233, 5.2, Rotation2d.fromDegrees(180)), true, false),
        new DecideArmPosCommand(ArmPosition.MID),
        new SetArmPosition(wristSubsystem, elevatorSubsystem, false),
        new WaitCommand(1),
        new IntakeCommand(intakeSubsystem, false)
    );
